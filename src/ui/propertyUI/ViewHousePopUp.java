...
public class ViewHousePopUp extends JPanel {
    ...
    private String[] joinedAttributes = new String[]{"PostalCode", "StreetAddress", "PropSize", "NumBedroom", "NumBathroom"};


    public ViewHousePopUp(ProcessPropertyRequest ppr, ArrayList<Boolean> attributesSelected) {
        super();
        ...
        searchButton.addActionListener(e -> {
            try {
                ppr.processViewHouse(cSelected, cAttributes, cOperations, cValues, joinedAttributes, attributesSelected);
