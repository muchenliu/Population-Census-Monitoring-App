...
public class ViewPropAmenPopUp extends JPanel {
    ...
    private String[] joinedAttributes = new String[]{"PostalCode", "StreetAddress", "PropSize", "NumBedroom", "NumBathroom", "Type", "OpeningHours"};


    public ViewPropAmenPopUp(ProcessPropertyRequest ppr, ArrayList<Boolean> attributesSelected) {
        super();
        ...
        searchButton.addActionListener(e -> {
            try {
                ppr.processViewAmen(cSelected, cAttributes, cOperations, cValues, joinedAttributes, attributesSelected);
