...
public class ViewPropCityPopUp extends JPanel {
    ...
    private String[] joinedAttributes = new String[]{"PostalCode", "StreetAddress", "PropSize", "NumBedroom", "NumBathroom", "CName", "PName"};


    public ViewPropCityPopUp(ProcessPropertyRequest ppr, ArrayList<Boolean> attributesSelected) {
        super();
        ...
        searchButton.addActionListener(e -> {
            try {
                ppr.processViewCity(cSelected, cAttributes, cOperations, cValues, joinedAttributes, attributesSelected);
