...
public class ViewPropValuePopUp  extends JPanel {
    ...
    private String[] joinedAttributes = new String[]{"PostalCode", "StreetAddress", "PropSize", "NumBedroom", "NumBathroom", "SalvageValue", "PropertyAge", "LastRenovation"};


    public ViewPropValuePopUp(ProcessPropertyRequest ppr, ArrayList<Boolean> attributesSelected) {
        super();
        ...
        searchButton.addActionListener(e -> {
            try {
                ppr.processViewValue(cSelected, cAttributes, cOperations, cValues, joinedAttributes, attributesSelected);
