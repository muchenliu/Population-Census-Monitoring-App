...
public class ViewTownhousePopUp extends JPanel {
    ...
    private String[] joinedAttributes = new String[]{"PostalCode", "StreetAddress", "PropSize", "NumBedroom", "NumBathroom", "Unit"};


    public ViewTownhousePopUp(ProcessPropertyRequest ppr, ArrayList<Boolean> attributesSelected) {
        super();
        ...
        searchButton.addActionListener(e -> {
            try {
                ppr.processViewTownhouse(cSelected, cAttributes, cOperations, cValues, joinedAttributes, attributesSelected);
